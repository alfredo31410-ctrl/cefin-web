...
export default function LandingLatam() {
  ...
  return (
    <div className="bg-black text-white font-sans selection:bg-orange-600 selection:text-white scroll-smooth">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              <button
                onClick={() => {
                  ...
                  // YA NO LE RESTAMOS 80PX. Ahora va al ras.
                  const targetPosition =
                    target.getBoundingClientRect().top + window.pageYOffset;
                  const startPosition = window.pageYOffset;
                  const distance = targetPosition - startPosition;
                  const duration = 1000; // 1 segundo exacto de duración
                  ...
                  const step = (timestamp: number) => {
                    ...
                    window.scrollTo(
                      0,
                      startPosition + distance * easeOutCubic(percentage),
                    );
      ...
      <section className="bg-zinc-900 py-24 px-6 border-y border-white/10">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              {
                t: "Marketing para Contadores",
                d: "Métodos probados para captar prospectos de calidad de forma orgánica y pagada.",
              },
              {
                t: "Digitalización de Despachos",
                d: "Cómo automatizar tus procesos sin perder el toque humano.",
              },
              {
                t: "Cierre de Ventas Efectivo",
                d: "Sistemas para cerrar ventas recurrentes y cobrar lo que vale tu trabajo.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="group p-8 bg-black border border-white/5 rounded-3xl hover:border-orange-600/50 transition-all"
              >
                <h4 className="text-xl font-bold mb-4 uppercase tracking-tighter text-white">
                  {item.t}
                </h4>
      ...
      <section
        id="pagos"
        className="bg-white py-24 px-6 relative z-20 border-none outline-none"
      >
        {/* Asegúrate de que no haya un 'pt-32' o similar aquí */}
        <div className="max-w-5xl mx-auto text-center text-black">
          ...
          <div className="mb-12 inline-flex gap-4 md:gap-8 justify-center bg-black text-white p-6 md:p-8 rounded-4xl shadow-2xl transform md:-translate-y-12">
            {[
              ...
              <div key={i} className="flex flex-col min-w-15">
                ...
                <span className="text-[10px] uppercase font-bold text-orange-500 tracking-widest mt-1">
                  {unit.label}
                </span>
              </div>
            ))}
          ...
          <h2 className="text-4xl md:text-6xl font-black mb-6 uppercase italic tracking-tighter text-balance">
            ASEGURA TU LUGAR <span className="text-orange-600">HOY MISMO</span>
          </h2>
          <p className="text-xl text-gray-500 mb-16 font-medium italic">
            Selecciona tu moneda local para ir al checkout seguro:
          </p>
              ...
              >
                <div className="w-full h-24 flex items-center justify-center mb-4">
                  <img
                    src={btn.img}
                    alt={btn.country}
                    className="max-h-full max-w-30 object-contain drop-shadow-md"
                  />
                </div>
                <div className="text-center">
                  <span className="text-black font-black text-2xl uppercase tracking-tighter block mb-2">
                    Pagar en {btn.country}
                  </span>
                  <span className="text-white bg-black font-bold text-[10px] px-4 py-2 rounded-full uppercase tracking-widest">
                    Pago con Hotmart
                  </span>
                </div>
              </a>
          ...
          <div className="p-10 border-2 border-dashed border-gray-200 rounded-[40px] bg-gray-50/50">
                ...
                <div className="bg-green-100 p-3 rounded-2xl text-green-600">
                  ...
                  >
                    <path
                      ...
                      strokeWidth="2"
                      d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04m14.236 0A11.97 11.97 0 0012 21.244a11.97 11.97 0 00-8.618-7.26m14.236 0L12 16.044l-5.618-2.06"
                    />
                  </svg>
                </div>
                <div>
                  ...
                  <p className="text-xs text-gray-500 font-medium italic leading-none">
            ...
            <div className="flex flex-wrap justify-center gap-10 grayscale opacity-40 hover:opacity-100 transition-all duration-700">
              ...
              <span className="font-black text-xl italic tracking-tighter underline underline-offset-4 decoration-orange-600">
                HOTMART
              </span>
            </div>
          </div>
