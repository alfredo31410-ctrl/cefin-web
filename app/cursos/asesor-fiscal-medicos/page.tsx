...
const LANDING_DATA = {
  title:
    "Cómo convertirte en asesor fiscal de médicos y dejar de cobrar como contador general.",
  subtitle:
    "Si atiendes médicos… probablemente estás perdiendo dinero (y ni lo sabes)",
  price: "$1,527",
  priceCurrency: "MXN",
  ...
  learnItems: [
    "Cómo tributan realmente los médicos",
    "Cómo aplicar correctamente deducciones",
    "Cómo identificar ingresos exentos y gravados",
    ...
    <div className="rounded-[2rem] border border-red-100 bg-white p-6 shadow-[0_20px_70px_rgba(0,0,0,0.08)] md:p-8">
      <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
        ...
        <div className="min-w-[260px] rounded-[1.5rem] bg-slate-950 p-6 text-white">
          ...
          >
            Quiero especializarme en médicos ahora
          </a>
        </div>
      </div>
    </div>
...
export default function LandingMedicos() {
  ...
  const handleCheckoutClick = () => {
    track("InitiateCheckout", {
      content_name: "Asesor Fiscal de Médicos",
      value: 1527,
      currency: "MXN",
    });
  };
            ...
            <Container>
              <div className="mx-auto max-w-4xl text-center">
                <h2 className="text-3xl font-black leading-tight text-slate-900 md:text-5xl">
                  ...
                  los impuestos en un sector específico como el médico.
                </h2>
          ...
          <section className="bg-white py-20 md:py-24">
            <Container>
              <div className="mx-auto max-w-5xl text-center">
                <h2 className="text-3xl font-black leading-tight text-slate-900 md:text-5xl">
                  El sector médico es uno de los mejor pagados…
                </h2>
              ...
              <div className="mx-auto max-w-5xl text-center">
                ...
                <div className="mt-8 overflow-hidden rounded-[2rem] border border-white/10 shadow-2xl">
                  <img
                    ...
                    alt="Antes y después - Asesor fiscal de médicos"
            ...
            <Container>
              <div className="mx-auto max-w-5xl">
                ...
                <h2 className="mt-4 text-center text-3xl font-black leading-tight text-slate-900 md:text-5xl">
                  Aplicación fiscal real para médicos
                </h2>
